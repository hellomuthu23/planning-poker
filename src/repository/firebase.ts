...
const firebaseConfig = {
  apiKey: process.env.VITE_FB_API_KEY || process.env.REACT_APP_FB_API_KEY,
  authDomain: process.env.VITE_FB_AUTH_DOMAIN || process.env.REACT_APP_FB_AUTH_DOMAIN,
  projectId: process.env.VITE_FB_PROJECT_ID || process.env.REACT_APP_FB_PROJECT_ID,
  storageBucket: process.env.VITE_FB_STORAGE_BUCKET || process.env.REACT_APP_FB_STORAGE_BUCKET,
  messagingSenderId:
    process.env.VITE_FB_MESSAGING_SENDER_ID || process.env.REACT_APP_FB_MESSAGING_SENDER_ID,
  appId: process.env.VITE_FB_APP_ID || process.env.REACT_APP_FB_APP_ID,
  measurementId: process.env.VITE_FB_MEASUREMENT_ID || process.env.REACT_APP_FB_MEASUREMENT_ID,
};
...
if (
  process.env.VITE_USE_FIRESTORE_EMULATOR === 'true' ||
